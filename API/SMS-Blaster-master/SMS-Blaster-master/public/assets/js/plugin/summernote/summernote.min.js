/*! SmartAdmin - v1.5 - 2014-09-27 */ ! function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a(window.jQuery) }(function(a) {
    ...
    var b, c = "function" == typeof define && define.amd,
        ...
        e = { "isMac": navigator.appVersion.indexOf("Mac") > -1, "isMSIE": navigator.userAgent.indexOf("MSIE") > -1 || navigator.userAgent.indexOf("Trident") > -1, "isFF": navigator.userAgent.indexOf("Firefox") > -1, "jqueryVersion": parseFloat(a.fn.jquery), "isSupportAmd": c, "hasCodeMirror": c ? require.specified("CodeMirror") : !!window.CodeMirror, "isFontInstalled": d },
        f = function() {
            var b = function(a) { return function(b) { return a === b } },
                ...
                h = 0,
                i = function(a) { var b = ++h + ""; return a ? a + b : b },
                j = function(b) { var c = a(document); return { "top": b.top + c.scrollTop(), "left": b.left + c.scrollLeft(), "width": b.right - b.left, "height": b.bottom - b.top } },
                k = function(a) { var b = {}; for (var c in a) a.hasOwnProperty(c) && (b[a[c]] = c); return b };
        ...
        g = function() {
            var a = function(a) { return a[0] },
                ...
                e = function(a, b) { var c = a.indexOf(b); return -1 === c ? null : a[c + 1] },
                g = function(a, b) { var c = a.indexOf(b); return -1 === c ? null : a[c - 1] },
                h = function(a, b) { return b = b || f.self, a.reduce(function(a, c) { return a + b(c) }, 0) },
        ...
        h = function() {
            var b = function(b) { return b && a(b).hasClass("note-editable") },
                ...
                n = function(a, b) { b = b || f.fail; var c = []; return m(a, function(a) { return c.push(a), b(a) }), c },
                o = function(b, c) {
                ...
                p = function(a, b) {
                    var c = [],
                        d = !1,
                        e = !1;
                    return function f(g) { if (g) { if (g === a && (d = !0), d && !e && c.push(g), g === b) return void(e = !0); for (var h = 0, i = g.childNodes.length; i > h; h++) f(g.childNodes[h]) } }(o(a, b)), c
                },
                q = function(a, b) { b = b || f.fail; for (var c = []; a && (c.push(a), !b(a));) a = a.previousSibling; return c },
                r = function(a, b) { b = b || f.fail; for (var c = []; a && (c.push(a), !b(a));) a = a.nextSibling; return c },
                s = function(a, b) {
                    var c = [];
                    return b = b || f.ok,
                ...
                x = function(a) { return 0 === a.offset || a.offset === w(a.node) },
                y = function(a) { for (var b = 0; a = a.previousSibling;) b += 1; return b },
                z = function(a) { return a && a.childNodes && a.childNodes.length },
                A = function(a) {
                    var c = a.node,
                        d = a.offset;
                    if (0 === d) return b(c) ? null : { "node": c.parentNode, "offset": y(c) };
                    if (z(c)) { var e = c.childNodes[d - 1]; return { "node": e, "offset": w(e) } }
                    return { "node": c, "offset": d - 1 }
                },
                B = function(b, c) { var d = g.initial(n(c, f.eq(b))); return a.map(d, y).reverse() },
                C = function(a, b) { for (var c = a, d = 0, e = b.length; e > d; d++) c = c.childNodes[b[d]]; return c },
                D = function(a, b) { if (0 === b) return a; if (b >= w(a)) return a.nextSibling; if (v(a)) return a.splitText(b); var c = a.childNodes[b]; return a = t(a.cloneNode(!1), a), u(a, r(c)) },
                E = function(a, b, c) { var d = n(b, f.eq(a)); return 1 === d.length ? D(b, c) : d.reduce(function(a, d) { var e = d.cloneNode(!1); return t(e, d), a === b && (a = D(a, c)), u(e, r(a)), e }) },
                F = function(a, b) {
                    if (a && a.parentNode) {
        ...
        j = function() {
            var b = function(b) {
                ...
                c = function(b) { return a.Deferred(function(c) { a("<img>").one("load", function() { c.resolve(a(this)) }).one("error abort", function() { c.reject(a(this)) }).css({ "display": "none" }).appendTo(document.body).attr("src", b) }).promise() };
            return { "readFileAsDataURL": b, "createImage": c }
        }(),
        k = { "isEdit": function(a) { return -1 !== [8, 9, 13, 32].indexOf(a) }, "nameFromCode": { "8": "BACKSPACE", "9": "TAB", "13": "ENTER", "32": "SPACE", "48": "NUM0", "49": "NUM1", "50": "NUM2", "51": "NUM3", "52": "NUM4", "53": "NUM5", "54": "NUM6", "55": "NUM7", "56": "NUM8", "66": "B", "69": "E", "73": "I", "74": "J", "75": "K", "76": "L", "82": "R", "83": "S", "85": "U", "89": "Y", "90": "Z", "191": "SLASH", "219": "LEFTBRACKET", "220": "BACKSLASH", "221": "RIGHTBRACKET" } },
        l = function() {
            var b = function(b, c) { if (e.jqueryVersion < 1.9) { var d = {}; return a.each(c, function(a, c) { d[c] = b.css(c) }), d } return b.css.call(b, c) };
            this.stylePara = function(b, c) { a.each(b.nodes(h.isPara), function(b, d) { a(d).css(c) }) }, this.current = function(c, d) {
        ...
        m = function() {
            var b = !!document.createRange,
                ...
                e = function(c, i, j, k) {
                    ...
                    var l = function() { if (b) { var a = document.createRange(); return a.setStart(c, i), a.setEnd(j, k), a } var e = d({ "cont": c, "offset": i }); return e.setEndPoint("EndToEnd", d({ "cont": j, "offset": k })), e };
                    this.getBPs = function() { return { "sc": c, "so": i, "ec": j, "eo": k } }, this.getStartBP = function() { return { "node": c, "offset": i } }, this.getEndBP = function() { return { "node": j, "offset": k } }, this.select = function() {
                        var a = l();
                        if (b) {
                        ...
                        var d = h.listBetween(c, j),
                            e = g.compact(a.map(d, function(a) { return h.ancestor(a, b) }));
                        return a.map(g.clusterBy(e, f.eq2), g.head)
                    }, this.commonAncestor = function() { return h.commonAncestor(c, j) }, this.expand = function(a) {
                        var b = h.ancestor(c, a),
                            d = h.ancestor(j, a);
                        if (!b && !d) return new e(c, i, j, k);
                        var f = this.getBPs();
                        return b && (f.sc = b, f.so = 0), d && (f.ec = d, f.eo = h.length(d)), new e(f.sc, f.so, f.ec, f.eo)
                    }, this.collapse = function(a) { return a ? new e(c, i, c, i) : new e(j, k, j, k) }, this.splitText = function() {
                        var a = c === j,
                            b = this.getBPs();
                        ...
                        return a.each(b.nodes(), function(a, b) { h.remove(b, !h.isPara(b)) }), new e(c.node, c.offset, c.node, c.offset)
                    };
                    var m = function(a) { return function() { var b = h.ancestor(c, a); return !!b && b === h.ancestor(j, a) } };
                    this.isOnEditable = m(h.isEditable), this.isOnList = m(h.isList), this.isOnAnchor = m(h.isAnchor), this.isOnCell = m(h.isCell), this.isCollapsed = function() { return c === j && i === k }, this.insertNode = function(c) {
                        var d = l();
                        if (b) d.insertNode(c);
                        else {
                        ...
                        return c
                    }, this.toString = function() { var a = l(); return b ? a.toString() : a.text }, this.bookmark = function(a) { return { "s": { "path": h.makeOffsetPath(a, c), "offset": i }, "e": { "path": h.makeOffsetPath(a, j), "offset": k } } }, this.getClientRects = function() { var a = l(); return a.getClientRects() }
                };
            return {
                ...
                "createFromNode": function(a) { return this.create(a, 0, a, 1) },
        ...
        o = function() {
            var b = new l,
                c = new n;
            this.saveRange = function(a) { a.focus(), a.data("range", m.create()) }, this.restoreRange = function(a) {
                var b = a.data("range");
                b && (b.select(), a.focus())
            }, this.currentStyle = function(a) { var c = m.create(); return c ? c.isOnEditable() && b.current(c, a) : !1 }, this.undo = function(a) { a.data("NoteHistory").undo(a) }, this.redo = function(a) { a.data("NoteHistory").redo(a) };
            for (var d = this.recordUndo = function(a) { a.data("NoteHistory").recordUndo(a) }, f = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "insertOrderedList", "insertUnorderedList", "indent", "outdent", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], i = 0, k = f.length; k > i; i++) this[f[i]] = function(a) { return function(b, c) { d(b), document.execCommand(a, !1, c) } }(f[i]);
            ...
            this.tab = function(a, b) {
                ...
                j.createImage(b).then(function(b) { d(a), b.css({ "display": "", "width": Math.min(a.width(), b.width()) }), m.create().insertNode(b[0]) }).fail(function() {
            ...
            }, this.formatBlock = function(a, b) { d(a), b = e.isMSIE ? "<" + b + ">" : b, document.execCommand("FormatBlock", !1, b) }, this.formatPara = function(a) { this.formatBlock(a, "P") };
            for (var i = 1; 6 >= i; i++) this["formatH" + i] = function(a) { return function(b) { this.formatBlock(b, "H" + a) } }(i);
            this.fontSize = function(a, b) { d(a), document.execCommand("fontSize", !1, 3), e.isFF ? a.find("font[size=3]").removeAttr("size").css("font-size", b + "px") : a.find("span").filter(function() { return "medium" === this.style.fontSize }).css("font-size", b + "px") }, this.lineHeight = function(a, c) { d(a), b.stylePara(m.create(), { "lineHeight": c }) }, this.unlink = function(a) {
                var b = m.create();
                if (b.isOnAnchor()) {
                    d(a);
            ...
            }, this.floatMe = function(a, b, c) { d(a), c.css("float", b) }, this.resize = function(a, b, c) { d(a), c.css({ "width": a.width() * b + "px", "height": "" }) }, this.resizeTo = function(a, b, c) {
                var d;
                if (c) {
                    var e = a.y / a.x,
                        f = b.data("ratio");
                ...
                b.css(d)
            }, this.removeMedia = function(a, b, c) { d(a), c.detach() }
        },
        p = function() {
            var a = [],
                b = [],
                ...
                d = function(a, b) { a.html(b.contents).scrollTop(b.scrollTop), m.createFromBookmark(a[0], b.bookmark).select() };
            ...
            }, this.recordUndo = function(d) { b = [], a.push(c(d)) }
        },
        q = function() {
        ...
        s = function() {
            ...
            }, this.updateRecentColor = function(a, c, d) { b.updateRecentColor(a, c, d) }, this.hide = function(a) { a.children().hide() }
        },
        t = function() {
            ...
            }, this.hide = function(a) { a.children().hide() }
        },
        u = function() {
            ...
            this.showImageDialog = function(c, d) {
                return a.Deferred(function(a) {
                    ...
                    c.one("shown.bs.modal", function() {
                        e.replaceWith(e.clone().on("change", function() { a.resolve(this.files), c.modal("hide") })), g.click(function(b) { b.preventDefault(), a.resolve(f.val()), c.modal("hide") }), f.on("keyup paste", function(a) {
                            var c;
                            c = "paste" === a.type ? a.originalEvent.clipboardData.getData("text") : f.val(), b(g, c)
                        }).val("").trigger("focus")
                    }).one("hidden.bs.modal", function() { e.off("change"), f.off("keyup paste"), g.off("click"), "pending" === a.state() && a.reject() }).modal("show")
                })
                ...
                return a.Deferred(function(a) {
                    ...
                    c.one("shown.bs.modal", function() { f.val(e.text).keyup(function() { b(g, f.val()) }).trigger("keyup").trigger("focus"), g.click(function(b) { b.preventDefault(), a.resolve(f.val()), c.modal("hide") }) }).one("hidden.bs.modal", function() { f.off("keyup"), g.off("click"), "pending" === a.state() && a.reject() }).modal("show")
                })
                ...
                return a.Deferred(function(a) {
                    ...
                    c.one("shown.bs.modal", function() { f.val(e.text), f.keyup(function() { e.text = f.val() }), e.url || (e.url = e.text, b(h, e.text)), g.keyup(function() { b(h, g.val()), e.text || f.val(g.val()) }).val(e.url).trigger("focus").trigger("select"), i.prop("checked", e.newWindow), h.one("click", function(b) { b.preventDefault(), a.resolve({ "range": e.range, "url": g.val(), "text": f.val(), "newWindow": i.is(":checked") }), c.modal("hide") }) }).one("hidden.bs.modal", function() { f.off("keyup"), g.off("keyup"), h.off("click"), "pending" === a.state() && a.reject() }).modal("show")
                }).promise()
            }, this.showHelpDialog = function(b, c) {
                return a.Deferred(function(a) {
                    var b = c.find(".note-help-dialog");
                    b.one("hidden.bs.modal", function() { a.resolve() }).modal("show")
                }).promise()
            }
        };
    ...
    var v = function() {
            var c = a(window),
                ...
                n = new t,
                q = new u,
                v = function(b) { var c = a(b).closest(".note-editor, .note-air-editor, .note-air-layout"); if (!c.length) return null; var d; return d = c.is(".note-editor, .note-air-editor") ? c : a("#note-editor-" + g.last(c.attr("id").split("-"))), h.buildLayoutInfo(d) },
                w = function(b, c) {
                    i.restoreRange(b);
                    var d = b.data("callbacks");
                    d.onImageUpload ? d.onImageUpload(c, i, b) : a.each(c, function(a, c) { j.readFileAsDataURL(c).then(function(a) { i.insertImage(b, a) }).fail(function() { d.onImageUploadError && d.onImageUploadError() }) })
                },
                x = {
                    "showLinkDialog": function(a) {
                        var b = a.editor(),
                            ...
                            e = i.getLinkInfo(d),
                            f = b.data("options");
                        i.saveRange(d), q.showLinkDialog(d, c, e).then(function(b) { i.restoreRange(d), i.createLink(d, b, f), m.hide(a.popover()) }).fail(function() { i.restoreRange(d) })
                    },
                    "showImageDialog": function(a) {
                        var b = a.dialog(),
                            c = a.editable();
                        i.saveRange(c), q.showImageDialog(c, b).then(function(a) { i.restoreRange(c), "string" == typeof a ? i.insertImage(c, a) : w(c, a) }).fail(function() { i.restoreRange(c) })
                    },
                    "showVideoDialog": function(a) {
                        var b = a.dialog(),
                            c = a.editable(),
                            d = i.getVideoInfo(c);
                        i.saveRange(c), q.showVideoDialog(c, b, d).then(function(a) { i.restoreRange(c), i.insertVideo(c, a) }).fail(function() { i.restoreRange(c) })
                    },
                    "showHelpDialog": function(a) {
                        var b = a.dialog(),
                            c = a.editable();
                        i.saveRange(c), q.showHelpDialog(c, b).then(function() { i.restoreRange(c) })
                    },
                    "fullscreen": function(a) {
                        var b = a.editor(),
                            ...
                            g = a.codable(),
                            h = b.data("options"),
                            i = function(a) { b.css("width", a.w), e.css("height", a.h), g.css("height", a.h), g.data("cmeditor") && g.data("cmeditor").setsize(null, a.h) };
                        b.toggleClass("fullscreen");
                        var j = b.hasClass("fullscreen");
                        j ? (e.data("orgheight", e.css("height")), c.on("resize", function() { i({ "w": c.width(), "h": c.height() - d.outerHeight() }) }).trigger("resize"), f.css("overflow", "hidden")) : (c.off("resize"), i({ "w": h.width || "", "h": e.data("orgheight") }), f.css("overflow", "visible")), l.updateFullscreen(d, j)
                    },
                    "codeview": function(a) {
                        var c, d, f = a.editor(),
                            g = a.toolbar(),
                ...
                y = function(a) { h.isImg(a.target) && a.preventDefault() },
                z = function(a) {
                    setTimeout(function() {
                ...
                C = function(b) {
                    if (h.isControlSizing(b.target)) {
                        ...
                        d.on("mousemove", function(a) { i.resizeTo({ "x": a.clientX - o.left, "y": a.clientY - (o.top - p) }, l, !a.shiftKey), n.update(e, { "image": k }, q), m.update(f, { "image": k }, q) }).one("mouseup", function() { d.off("mousemove") }), l.data("ratio") || l.data("ratio", l.height() / l.width()), i.recordUndo(g)
                    }
                },
                D = function(b) {
                ...
                G = function(a) {
                    ...
                    }).one("mouseup", function() { d.off("mousemove") })
                },
                H = 18,
                I = function(b, c) {
                ...
                J = function(b) {
                    ...
                    }).on("dragleave", function(a) { c = c.not(a.target), c.length || b.editor.removeClass("dragover") }).on("drop", function() { c = a(), b.editor.removeClass("dragover") }), e.on("dragenter", function() { e.addClass("hover"), f.text("Drop Image") }).on("dragleave", function() { e.removeClass("hover"), f.text("Drag Image Here") }), e.on("drop", function(a) {
                        a.preventDefault();
            ...
            this.bindKeyMap = function(a, b) {
                ...
                if (d.css({ "width": b.insertTableMaxSize.col + "em", "height": b.insertTableMaxSize.row + "em" }).on("mousemove", function(a) { I(a, b) }), a.editor.data("options", b), b.styleWithSpan && !e.isMSIE && setTimeout(function() { document.execCommand("styleWithCSS", 0, !0) }, 0), a.editable.data("NoteHistory", new p), b.onenter && a.editable.keypress(function(a) { a.keyCode === k.ENTER && b.onenter(a) }), b.onfocus && a.editable.focus(b.onfocus), b.onblur && a.editable.blur(b.onblur), b.onkeyup && a.editable.keyup(b.onkeyup), b.onkeydown && a.editable.keydown(b.onkeydown), b.onpaste && a.editable.on("paste", b.onpaste), b.onToolbarClick && a.toolbar.click(b.onToolbarClick), b.onChange) {
                    var f = function() { b.onChange(a.editable, a.editable.html()) };
                    if (e.isMSIE) {
            ...
            }, this.dettach = function(a, b) { a.editable.off(), a.popover.off(), a.handle.off(), a.dialog.off(), b.airMode || (a.dropzone.off(), a.toolbar.off(), a.statusbar.off()) }
        },
        w = function() {
            var b = function(a, b) {
                    var c = b.event,
                ...
                c = function(a, c) { var d = '<i class="' + a + '"></i>'; return b(d, c) },
                d = function(a, b) { return '<div class="' + a + ' popover bottom in" style="display: none;"><div class="arrow"></div><div class="popover-content">' + b + "</div></div>" },
                ...
                i = {
                    "picture": function(a) { return c("fa fa-picture-o icon-picture", { "event": "showImageDialog", "title": a.image.image }) },
                    "link": function(a) { return c("fa fa-link icon-link", { "event": "showLinkDialog", "title": a.link.link }) },
                    "video": function(a) { return c("fa fa-youtube-play icon-play", { "event": "showVideoDialog", "title": a.video.video }) },
                    "table": function(a) { var b = '<ul class="dropdown-menu"><div class="note-dimension-picker"><div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div><div class="note-dimension-picker-highlighted"></div><div class="note-dimension-picker-unhighlighted"></div></div><div class="note-dimension-display"> 1 x 1 </div></ul>'; return c("fa fa-table icon-table", { "title": a.table.table, "dropdown": b }) },
                    "style": function(a, b) { var d = b.styleTags.reduce(function(b, c) { var d = a.style["p" === c ? "normal" : c]; return b + '<li><a data-event="formatBlock" href="#" data-value="' + c + '">' + ("p" === c || "pre" === c ? d : "<" + c + ">" + d + "</" + c + ">") + "</a></li>" }, ""); return c("fa fa-magic icon-magic", { "title": a.style.style, "dropdown": '<ul class="dropdown-menu">' + d + "</ul>" }) },
                    "fontname": function(a, c) {
                        var d = c.fontNames.reduce(function(a, b) { return e.isFontInstalled(b) ? a + '<li><a data-event="fontName" href="#" data-value="' + b + '"><i class="fa fa-check icon-ok"></i> ' + b + "</a></li>" : a }, ""),
                    ...
                    "fontsize": function(a, c) {
                        var d = c.fontSizes.reduce(function(a, b) { return a + '<li><a data-event="fontSize" href="#" data-value="' + b + '"><i class="fa fa-check icon-ok"></i> ' + b + "</a></li>" }, ""),
                    ...
                    "bold": function(a) { return c("fa fa-bold icon-bold", { "event": "bold", "title": a.font.bold }) },
                    "italic": function(a) { return c("fa fa-italic icon-italic", { "event": "italic", "title": a.font.italic }) },
                    "underline": function(a) { return c("fa fa-underline icon-underline", { "event": "underline", "title": a.font.underline }) },
                    "strikethrough": function(a) { return c("fa fa-strikethrough icon-strikethrough", { "event": "strikethrough", "title": a.font.strikethrough }) },
                    "superscript": function(a) { return c("fa fa-superscript icon-superscript", { "event": "superscript", "title": a.font.superscript }) },
                    "subscript": function(a) { return c("fa fa-subscript icon-subscript", { "event": "subscript", "title": a.font.subscript }) },
                    "clear": function(a) { return c("fa fa-eraser icon-eraser", { "event": "removeFormat", "title": a.font.clear }) },
                    "ul": function(a) { return c("fa fa-list-ul icon-list-ul", { "event": "insertUnorderedList", "title": a.lists.unordered }) },
                    "ol": function(a) { return c("fa fa-list-ol icon-list-ol", { "event": "insertOrderedList", "title": a.lists.ordered }) },
                    "paragraph": function(a) {
                        var b = c("fa fa-align-left icon-align-left", { "title": a.paragraph.left, "event": "justifyLeft" }),
                            d = c("fa fa-align-center icon-align-center", { "title": a.paragraph.center, "event": "justifyCenter" }),
                            e = c("fa fa-align-right icon-align-right", { "title": a.paragraph.right, "event": "justifyRight" }),
                            f = c("fa fa-align-justify icon-align-justify", { "title": a.paragraph.justify, "event": "justifyFull" }),
                            g = c("fa fa-outdent icon-indent-left", { "title": a.paragraph.outdent, "event": "outdent" }),
                            h = c("fa fa-indent icon-indent-right", { "title": a.paragraph.indent, "event": "indent" }),
                    ...
                    "height": function(a, b) { var d = b.lineHeights.reduce(function(a, b) { return a + '<li><a data-event="lineHeight" href="#" data-value="' + parseFloat(b) + '"><i class="fa fa-check icon-ok"></i> ' + b + "</a></li>" }, ""); return c("fa fa-text-height icon-text-height", { "title": a.font.height, "dropdown": '<ul class="dropdown-menu">' + d + "</ul>" }) },
                    "help": function(a) { return c("fa fa-question icon-question", { "event": "showHelpDialog", "title": a.options.help }) },
                    "fullscreen": function(a) { return c("fa fa-arrows-alt icon-fullscreen", { "event": "fullscreen", "title": a.options.fullscreen }) },
                    "codeview": function(a) { return c("fa fa-code icon-code", { "event": "codeview", "title": a.options.codeview }) },
                    "undo": function(a) { return c("fa fa-undo icon-undo", { "event": "undo", "title": a.history.undo }) },
                    "redo": function(a) { return c("fa fa-repeat icon-repeat", { "event": "redo", "title": a.history.redo }) },
                    "hr": function(a) { return c("fa fa-minus icon-hr", { "event": "insertHorizontalRule", "title": a.hr.insert }) }
                },
                j = function(a, e) {
                    var f = function() {
                            var b = c("fa fa-edit icon-edit", { "title": a.link.edit, "event": "showLinkDialog" }),
                                e = c("fa fa-unlink icon-unlink", { "title": a.link.unlink, "event": "unlink" }),
                        ...
                        g = function() {
                            var e = b('<span class="note-fontsize-10">100%</span>', { "title": a.image.resizeFull, "event": "resize", "value": "1" }),
                                ...
                                h = c("fa fa-align-left icon-align-left", { "title": a.image.floatLeft, "event": "floatMe", "value": "left" }),
                                i = c("fa fa-align-right icon-align-right", { "title": a.image.floatRight, "event": "floatMe", "value": "right" }),
                                j = c("fa fa-align-justify icon-align-justify", { "title": a.image.floatNone, "event": "floatMe", "value": "none" }),
                                k = c("fa fa-trash-o icon-trash", { "title": a.image.remove, "event": "removeMedia", "value": "none" }),
                ...
                k = function() { return '<div class="note-handle"><div class="note-control-selection"><div class="note-control-selection-bg"></div><div class="note-control-holder note-control-nw"></div><div class="note-control-holder note-control-ne"></div><div class="note-control-holder note-control-sw"></div><div class="note-control-sizing note-control-se"></div><div class="note-control-selection-info"></div></div></div>' },
                l = function(a, b) { return '<table class="note-shortcut"><thead><tr><th></th><th>' + a + "</th></tr></thead><tbody>" + b + "</tbody></table>" },
                m = function(a) { var b = "<tr><td>\u2318 + B</td><td>" + a.font.bold + "</td></tr><tr><td>\u2318 + I</td><td>" + a.font.italic + "</td></tr><tr><td>\u2318 + U</td><td>" + a.font.underline + "</td></tr><tr><td>\u2318 + \u21e7 + S</td><td>" + a.font.strikethrough + "</td></tr><tr><td>\u2318 + \\</td><td>" + a.font.clear + "</td></tr>"; return l(a.shortcut.textFormatting, b) },
                n = function(a) { var b = "<tr><td>\u2318 + Z</td><td>" + a.history.undo + "</td></tr><tr><td>\u2318 + \u21e7 + Z</td><td>" + a.history.redo + "</td></tr><tr><td>\u2318 + ]</td><td>" + a.paragraph.indent + "</td></tr><tr><td>\u2318 + [</td><td>" + a.paragraph.outdent + "</td></tr><tr><td>\u2318 + ENTER</td><td>" + a.hr.insert + "</td></tr>"; return l(a.shortcut.action, b) },
                o = function(a) { var b = "<tr><td>\u2318 + \u21e7 + L</td><td>" + a.paragraph.left + "</td></tr><tr><td>\u2318 + \u21e7 + E</td><td>" + a.paragraph.center + "</td></tr><tr><td>\u2318 + \u21e7 + R</td><td>" + a.paragraph.right + "</td></tr><tr><td>\u2318 + \u21e7 + J</td><td>" + a.paragraph.justify + "</td></tr><tr><td>\u2318 + \u21e7 + NUM7</td><td>" + a.lists.ordered + "</td></tr><tr><td>\u2318 + \u21e7 + NUM8</td><td>" + a.lists.unordered + "</td></tr>"; return l(a.shortcut.paragraphFormatting, b) },
                p = function(a) { var b = "<tr><td>\u2318 + NUM0</td><td>" + a.style.normal + "</td></tr><tr><td>\u2318 + NUM1</td><td>" + a.style.h1 + "</td></tr><tr><td>\u2318 + NUM2</td><td>" + a.style.h2 + "</td></tr><tr><td>\u2318 + NUM3</td><td>" + a.style.h3 + "</td></tr><tr><td>\u2318 + NUM4</td><td>" + a.style.h4 + "</td></tr><tr><td>\u2318 + NUM5</td><td>" + a.style.h5 + "</td></tr><tr><td>\u2318 + NUM6</td><td>" + a.style.h6 + "</td></tr>"; return l(a.shortcut.documentStyle, b) },
                q = function(a, b) {
                    var c = b.extraKeys,
                        d = "";
                ...
                r = function(a, b) { var c = '<table class="note-shortcut-layout"><tbody><tr><td>' + n(a, b) + "</td><td>" + m(a, b) + "</td></tr><tr><td>" + p(a, b) + "</td><td>" + o(a, b) + "</td></tr>"; return b.extraKeys && (c += '<tr><td colspan="2">' + q(a, b) + "</td></tr>"), c += "</tbody</table>" },
                s = function(a) { return a.replace(/\u2318/g, "Ctrl").replace(/\u21e7/g, "Shift") },
                t = function(a, b) {
                    var c = function() {
                        ...
                        h = function() { var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close + '</a><div class="title">' + a.shortcut.shortcuts + "</div>" + (e.isMac ? r(a, b) : s(r(a, b))) + '<p class="text-center"><a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.3</a> \xb7 <a href="//github.com/HackerWins/summernote" target="_blank">Project</a> \xb7 <a href="//github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p>'; return g("note-help-dialog", "", c, "") };
                    return '<div class="note-dialog">' + c() + d() + f() + h() + "</div>"
                },
                u = function() { return '<div class="note-resizebar"><div class="note-icon-bar"></div><div class="note-icon-bar"></div><div class="note-icon-bar"></div></div>' },
                v = function(a) { return e.isMac && (a = a.replace("CMD", "\u2318").replace("SHIFT", "\u21e7")), a.replace("BACKSLASH", "\\").replace("SLASH", "/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]") },
                w = function(b, c, d) {
                    ...
                    g.each(function(b, c) {
                        var d = a(c),
                            f = e[d.data("event")];
                        f && d.attr("title", function(a, b) { return b + " (" + v(f) + ")" })
                    }).tooltip({ "container": "body", "trigger": "hover", "placement": d || "top" }).on("click", function() { a(this).tooltip("hide") })
                },
                x = function(b, c) {
                    var d = c.colors;
            ...
            this.createLayoutByAirMode = function(b, c) {
                ...
                var n = a(t(g, c));
                n.addClass("note-air-layout"), n.attr("id", "note-dialog-" + h), n.find("button.close, a.modal-close").click(function() { a(this).closest(".modal").modal("hide") }), n.appendTo(i)
    ...
    a.fn.extend({
        "summernote": function(b) {
            if (b = a.extend({}, a.summernote.options, b), this.each(function(c, d) {
                    ...
                    y.attach(f, b), h.isTextarea(e[0]) && e.closest("form").submit(function() { e.val(e.code()) })
        ...
        "code": function(b) {
            if (void 0 === b) { var c = this.first(); if (!c.length) return; var d = x.layoutInfoFromHolder(c); if (d && d.editable) { var f = d.editor.hasClass("codeview"); return f && e.hasCodeMirror && d.codable.data("cmEditor").save(), f ? d.codable.val() : d.editable.html() } return h.isTextarea(c[0]) ? c.val() : c.html() }
