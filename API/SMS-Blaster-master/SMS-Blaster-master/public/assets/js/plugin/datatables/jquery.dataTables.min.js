    ...
    ! function(a) { "use strict"; "function" == typeof define && define.amd ? define("datatables", ["jquery"], a) : "object" == typeof exports ? a(require("jquery")) : jQuery && !jQuery.fn.dataTable && a(jQuery) }(function(d) {
        ...
        function e(a) {
            var b, c, f = "a aa ai ao as b fn i m o s ",
                g = {};
            d.each(a, function(d) { b = d.match(/^([^A-Z]+?)([A-Z])/), b && -1 !== f.indexOf(b[1] + " ") && (c = d.replace(b[0], b[2].toLowerCase()), g[c] = d, "o" === b[1] && e(a[d])) }), a._hungarianMap = g
        }

        function f(a, b, g) {
            a._hungarianMap || e(a);
            var h;
            d.each(b, function(e) { h = a._hungarianMap[e], h === c || !g && b[h] !== c || ("o" === h.charAt(0) ? (b[h] || (b[h] = {}), d.extend(!0, b[h], b[e]), f(a[h], b[h], g)) : b[h] = b[e]) })
        }
        ...
        function i(a) { rc(a, "orderable", "bSortable"), rc(a, "orderData", "aDataSort"), rc(a, "orderSequence", "asSorting"), rc(a, "orderDataType", "sortDataType") }
        ...
        function l(a, c) {
            var e = Wb.defaults.column,
                ...
                g = d.extend({}, Wb.models.oColumn, e, { "nTh": c ? c : b.createElement("th"), "sTitle": e.sTitle ? e.sTitle : c ? c.innerHTML : "", "aDataSort": e.aDataSort ? e.aDataSort : [f], "mData": e.mData ? e.mData : f, "idx": f });
            a.aoColumns.push(g);
        ...
        function m(a, b, e) {
            ...
            g._bAttrSrc = d.isPlainObject(l) && (o(l.sort) || o(l.type) || o(l.filter)), g.fnGetData = function(a, b, d) { var e = m(a, b, c, d); return n && b ? n(e, b, a, d) : e }, g.fnSetData = function(a, b, c) { return C(l)(a, b, c) }, a.oFeatures.bSort || (g.bSortable = !1, j.addClass(h.sSortableNone));
        ...
        function s(a) {
            ...
            for (b = 0, d = l.length; d > b; b++)
                ...
                for (e = 0, f = n.length; f > e; e++) { for (g = 0, h = m.length; h > g && (k[g] === c && (k[g] = y(a, g, b, "type")), j = n[e](k[g], a), j && "html" !== j); g++); if (j) { i.sType = j; break } }
        ...
        function u(a, b, c, e) {
            var f = a.aoData.length,
                g = d.extend(!0, {}, Wb.models.oRow, { "src": c ? "dom" : "data" });
        ...
        function B(a) {
            ...
            if ("string" != typeof a || -1 === a.indexOf(".") && -1 === a.indexOf("[") && -1 === a.indexOf("(")) return function(b) { return b[a] };
        ...
        function C(a) {
            ...
            if ("string" != typeof a || -1 === a.indexOf(".") && -1 === a.indexOf("[") && -1 === a.indexOf("(")) return function(b, c) { b[a] = c };
            var b = function(a, d, e) {
                for (var f, g, h, i, j, k = A(e), l = k[k.length - 1], m = 0, n = k.length - 1; n > m; m++) {
                    if (g = k[m].match(sc), h = k[m].match(tc), g) { k[m] = k[m].replace(sc, ""), a[k[m]] = [], f = k.slice(), f.splice(0, m + 1), j = f.join("."); for (var o = 0, p = d.length; p > o; o++) i = {}, b(i, d[o], j), a[k[m]].push(i); return }
        ...
        function D(a) { return mc(a.aoData, "_aData") }
        ...
        function H(a, b) {
            var c, e, f, g, h = [],
                ...
                n = function(a) { e = l[k], g = d.trim(a.innerHTML), e && e._bAttrSrc ? (f = { "display": g }, m(e.mData.sort, f, a), m(e.mData.type, f, a), m(e.mData.filter, f, a), h.push(f)) : h.push(g), k++ };
            if (j)
                for (; j;) c = j.nodeName.toUpperCase(), ("TD" == c || "TH" == c) && (n(j), i.push(j)), j = j.nextSibling;
            else { i = b.anCells; for (var o = 0, p = i.length; p > o; o++) n(i[o]) }
        ...
        function K(a) {
            ...
            if (j && P(a.aoHeader, h), d(h).find(">tr").attr("role", "row"), d(h).find(">tr>th, >tr>td").addClass(k.sHeaderTH), d(i).find(">tr>th, >tr>td").addClass(k.sFooterTH), null !== i) { var m = a.aoFooter[0]; for (b = 0, c = m.length; c > b; b++) g = l[b], g.nTf = m[b].cell, g.sClass && d(g.nTf).addClass(g.sClass) }
        }
                ...
                for (c = o[f], k = 0, e = c.firstChild; e;) {
                    if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase())
                        for (l = 1 * e.getAttribute("colspan"), m = 1 * e.getAttribute("rowspan"), l = l && 0 !== l && 1 !== l ? l : 1, m = m && 0 !== m && 1 !== m ? m : 1, j = p(a, f, k), n = 1 === l ? !0 : !1, h = 0; l > h; h++)
                            for (g = 0; m > g; g++) a[f + g][j + h] = { "cell": e, "unique": n }, a[f + g].nTr = c;
                    e = e.nextSibling
                }
        }
        ...
        function R(a, b, c) {
            ...
            var k = {
                ...
                "error": function(b, c) { var d = a.oApi._fnLog; "parsererror" == c ? d(a, 0, "Invalid JSON response", 1) : 4 === b.readyState && d(a, 0, "Ajax error", 7), ob(a, !1) }
            };
            a.oAjaxData = b, Pb(a, null, "preXhr", [a, b]), a.fnServerData ? a.fnServerData.call(i, a.sAjaxSource, d.map(b, function(a, b) { return { "name": b, "value": a } }), c, a) : a.sAjaxSource || "string" == typeof h ? a.jqXHR = d.ajax(d.extend(k, { "url": h || a.sAjaxSource })) : d.isFunction(h) ? a.jqXHR = h.call(i, b, c, a) : (a.jqXHR = d.ajax(d.extend(k, h)), h.data = g)
        }

        function S(a) { return a.bAjaxDataGet ? (a.iDraw++, ob(a, !0), R(a, T(a), function(b) { U(a, b) }), !1) : !0 }
        ...
        function W(a) {
            ...
            var k = d("<div/>", { "id": h.f ? null : e + "_filter", "class": c.sFilter }).append(d("<label/>").append(j)),
                ...
                m = d("input", k).val(g.sSearch).attr("placeholder", f.sSearchPlaceholder).bind("keyup.DT search.DT input.DT paste.DT cut.DT", "ssp" === Sb(a) ? tb(l, 400) : l).bind("keypress.DT", function(a) { return 13 == a.keyCode ? !1 : void 0 }).attr("aria-controls", e);
            return d(a.nTable).on("search.dt.DT", function(c, d) { if (a === d) try { m[0] !== b.activeElement && m.val(g.sSearch) } catch (e) {} }), k[0]
        }
        ...
        function _(a, b, c, e) {
            if (a = b ? a : ab(a), c) {
                var f = d.map(a.match(/"[^"]+"|[^ ]+/g) || "", function(a) { return '"' === a.charAt(0) ? a.match(/^"(.*)"$/)[1] : a });
                a = "^(?=.*?" + f.join(")(?=.*?") + ").*$"
            }
            return new RegExp(a, e ? "i" : "")
        }

        function ab(a) { return a.replace(ec, "\\$1") }
        ...
        function hb(a) {
            var b, c, d, e = a.iInitDisplayStart,
                f = a.aoColumns,
                g = a.oFeatures;
            if (!a.bInitialised) return void setTimeout(function() { hb(a) }, 200);
        ...
        function ib(a, b) { a._bInitComplete = !0, b && n(a), Pb(a, "aoInitComplete", "init", [a, b]) }
        ...
        function nb(a) { return d("<div/>", { "id": a.aanFeatures.r ? null : a.sTableId + "_processing", "class": a.oClasses.sProcessing }).html(a.oLanguage.sProcessing).insertBefore(a.nTable)[0] }

        function ob(a, b) { a.oFeatures.bProcessing && d(a.aanFeatures.r).css("display", b ? "block" : "none"), Pb(a, null, "processing", [a, b]) }
        ...
        function pb(a) {
            ...
            var e = c.sX,
                ...
                l = b.children("tfoot"),
                m = "<div/>",
                n = function(a) { return a ? yb(a) : null };
        ...
        function sb(b) {
            ...
            u && (i.style.width = yb(u)), !u && !m || b._reszEvt || (d(a).bind("resize.DT-" + b.sInstance, tb(function() { n(b) })), b._reszEvt = !0)
        }
        ...
        function tb(a, b) {
            ...
            return function() {
                var b = this,
                    g = +new Date,
                    h = arguments;
                d && d + f > g ? (clearTimeout(e), e = setTimeout(function() { d = c, a.apply(b, h) }, f)) : d ? (d = g, a.apply(b, h)) : d = g
            }
        }
        ...
        function wb(a, b) { var c = xb(a, b); if (0 > c) return null; var e = a.aoData[c]; return e.nTr ? e.anCells[b] : d("<td/>").html(y(a, c, b, "display"))[0] }

        function xb(a, b) { for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; g > f; f++) c = y(a, f, b, "display") + "", c = c.replace(wc, ""), c.length > d && (d = c.length, e = f); return e }

        function yb(a) { return null === a ? "0px" : "number" == typeof a ? 0 > a ? "0px" : a + "px" : a.match(/\d$/) ? a + "px" : a }
        ...
        function Ab(a) {
            var b, c, e, f, g, h, i, j = [],
                ...
                m = d.isPlainObject(l),
                n = [],
                o = function(a) { a.length && !d.isArray(a[0]) ? n.push(a) : n.push.apply(n, a) };
            for (d.isArray(l) && o(l), m && l.pre && o(l.pre), o(a.aaSorting), m && l.post && o(l.post), b = 0; b < n.length; b++)
                for (i = n[b][0], f = k[i].aDataSort, c = 0, e = f.length; e > c; c++) g = f[c], h = k[g].sType || "string", j.push({ "src": i, "col": g, "dir": n[b][1], "index": n[b][2], "type": h, "formatter": Wb.ext.type.order[h + "-pre"] });
            return j
        }
        ...
        function Db(a, b, e, f) {
            var g, h = a.aoColumns[b],
                i = a.aaSorting,
                j = h.asSorting,
                k = function(a) { var b = a._idx; return b === c && (b = d.inArray(a[1], j)), b + 1 >= j.length ? 0 : b + 1 };
        ...
        function Eb(a, b, c, d) {
            var e = a.aoColumns[c];
            Nb(b, {}, function(b) { e.bSortable !== !1 && (a.oFeatures.bProcessing ? (ob(a, !0), setTimeout(function() { Db(a, c, b.shiftKey, d), "ssp" !== Sb(a) && ob(a, !1) }, 0)) : Db(a, c, b.shiftKey, d)) })
        }
        ...
        function Fb(a) {
            var b, c, e, f = a.aLastSort,
                ...
                h = Ab(a),
                i = a.oFeatures;
            if (i.bSort && i.bSortClasses) { for (b = 0, c = f.length; c > b; b++) e = f[b].src, d(mc(a.aoData, "anCells", e)).removeClass(g + (2 > b ? b + 1 : 3)); for (b = 0, c = h.length; c > b; b++) e = h[b].src, d(mc(a.aoData, "anCells", e)).addClass(g + (2 > b ? b + 1 : 3)) }
            a.aLastSort = h
        }
        ...
        function Hb(a) {
            if (a.oFeatures.bStateSave && !a.bDestroying) {
                var b = { "time": +new Date, "start": a._iDisplayStart, "length": a._iDisplayLength, "order": d.extend(!0, [], a.aaSorting), "search": cb(a.oPreviousSearch), "columns": d.map(a.aoColumns, function(b, c) { return { "visible": b.bVisible, "search": cb(a.aoPreSearchCols[c]) } }) };
                ...
                if (f && f.time) {
                    ...
                    if (-1 === d.inArray(!1, g)) {
                        ...
                        if (!(h > 0 && f.time < +new Date - 1e3 * h) && e.length === f.columns.length) {
                            for (a.oLoadedState = d.extend(!0, {}, f), a._iDisplayStart = f.start, a.iInitDisplayStart = f.start, a._iDisplayLength = f.length, a.aaSorting = [], d.each(f.order, function(b, c) { a.aaSorting.push(c[0] >= e.length ? [0, c[1]] : c) }), d.extend(a.oPreviousSearch, db(f.search)), b = 0, c = f.columns.length; c > b; b++) {
                                var i = f.columns[b];
        ...
        function Mb(a, b, c) { var e; for (var f in b) b.hasOwnProperty(f) && (e = b[f], d.isPlainObject(e) ? (d.isPlainObject(a[f]) || (a[f] = {}), d.extend(!0, a[f], e)) : a[f] = c && "data" !== f && "aaData" !== f && d.isArray(e) ? e.slice() : e); return a }
        ...
        function Pb(a, b, c, e) { var f = []; return b && (f = d.map(a[b].slice().reverse(), function(b) { return b.fn.apply(a.oInstance, e) })), null !== c && d(a.nTable).trigger(c + ".dt", e), f }
        ...
        function Ub(a) { d.each({ "num": function(b) { return Tc(b, a) }, "num-fmt": function(b) { return Tc(b, a, fc) }, "html-num": function(b) { return Tc(b, a, bc) }, "html-num-fmt": function(b) { return Tc(b, a, bc, fc) } }, function(b, c) { Xb.type.order[b + a + "-pre"] = c }) }

        function Vb(a) { return function() { var b = [Jb(this[Wb.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments)); return Wb.ext.internal[a].apply(this, b) } }
        var Wb, Xb, Yb, Zb, $b, _b = {},
            ...
            fc = /[',$\xa3\u20ac\xa5%\u2009\u202F]/g,
            gc = function(a) { return a && a !== !0 && "-" !== a ? !1 : !0 },
            hc = function(a) { var b = parseInt(a, 10); return !isNaN(b) && isFinite(a) ? b : null },
            ic = function(a, b) { return _b[b] || (_b[b] = new RegExp(ab(b), "g")), "string" == typeof a ? a.replace(/\./g, "").replace(_b[b], ".") : a },
            jc = function(a, b, c) { var d = "string" == typeof a; return b && d && (a = ic(a, b)), c && d && (a = a.replace(fc, "")), gc(a) || !isNaN(parseFloat(a)) && isFinite(a) },
            kc = function(a) { return gc(a) || "string" == typeof a },
            lc = function(a, b, c) { if (gc(a)) return !0; var d = kc(a); return d && jc(pc(a), b, c) ? !0 : null },
            mc = function(a, b, d) {
                var e = [],
                    f = 0,
                    g = a.length;
            ...
            pc = function(a) { return a.replace(bc, "") },
            qc = function(a) {
                var b, c, d, e = [],
                    f = a.length,
                    g = 0;
            ...
            rc = function(a, b, d) { a[b] !== c && (a[d] = a[b]) },
            sc = /\[.*?\]$/,
            tc = /\(\)$/,
            uc = d("<div>")[0],
            vc = uc.textContent !== c,
            wc = /<.*?>/g;
        Wb = function(a) {
            this.$ = function(a, b) { return this.api(!0).$(a, b) }, this._ = function(a, b) { return this.api(!0).rows(a, b).data() }, this.api = function(a) { return new Yb(a ? Jb(this[Xb.iApiIndex]) : this) }, this.fnAddData = function(a, b) {
                var e = this.api(!0),
            ...
            }, this.fnSettings = function() { return Jb(this[Xb.iApiIndex]) }, this.fnSort = function(a) { this.api(!0).order(a).draw() }, this.fnSortListener = function(a, b, c) { this.api(!0).order.listener(a, b, c) }, this.fnUpdate = function(a, b, d, e, f) { var g = this.api(!0); return d === c || null === d ? g.row(b).data(a) : g.cell(b, d).data(a), (f === c || f) && g.columns.adjust(), (e === c || e) && g.draw(), 0 }, this.fnVersionCheck = Xb.fnVersionCheck;
            var b = this,
                e = a === c,
                k = this.length;
            ...
            return this.each(function() {
                ...
                "" !== p.oLanguage.sUrl ? (A.oLanguage.sUrl = p.oLanguage.sUrl, d.getJSON(A.oLanguage.sUrl, null, function(a) { g(a), f(w.oLanguage, a), d.extend(!0, A.oLanguage, p.oLanguage, a), hb(A) }), s = !0) : d.extend(!0, A.oLanguage, p.oLanguage), null === p.asStripeClasses && (A.asStripeClasses = [B.sStripeOdd, B.sStripeEven]);
                var D = A.asStripeClasses,
                    E = d("tbody tr:eq(0)", this); - 1 !== d.inArray(!0, d.map(D, function(a) { return E.hasClass(a) })) && (d("tbody tr", this).removeClass(D.join(" ")), A.asDestroyStripes = D.slice());
                var F, G = [],
                ...
                var K = A.oFeatures;
                if (p.bStateSave && (K.bStateSave = !0, Ib(A, p), Ob(A, "aoDrawCallback", Hb, "state_save")), p.aaSorting === c) { var L = A.aaSorting; for (q = 0, n = L.length; n > q; q++) L[q][1] = A.aoColumns[q].asSorting[0] }
                Fb(A), K.bSort && Ob(A, "aoDrawCallback", function() {
                    if (A.bSorted) {
                        var a = Ab(A),
                            b = {};
                        d.each(a, function(a, c) { b[c.src] = c.dir }), Pb(A, null, "order", [A, a, b]), Cb(A)
                    }
        ...
        var xc = [],
            ...
            zc = function(a) {
                var b, c, e = Wb.settings,
                    f = d.map(e, function(a) { return a.nTable });
                return a ? a.nTable && a.oApi ? [a] : a.nodeName && "table" === a.nodeName.toLowerCase() ? (b = d.inArray(a, f), -1 !== b ? [e[b]] : null) : a && "function" == typeof a.settings ? a.settings().toArray() : ("string" == typeof a ? c = d(a) : a instanceof d && (c = a), c ? c.map(function() { return b = d.inArray(this, f), -1 !== b ? e[b] : null }).toArray() : void 0) : []
            };
        Yb = function(a, b) {
            ...
            "eq": function(a) { var b = this.context; return b.length > a ? new Yb(b[a], this[a]) : null },
            "filter": function(a) {
                var b = [];
            ...
            "flatten": function() { var a = []; return new Yb(this.context, a.concat.apply(a, this.toArray())) },
            "join": yc.join,
            ...
            "lastIndexOf": yc.lastIndexOf || function() { return this.indexOf.apply(this.toArray.reverse(), arguments) },
            "length": 0,
            "map": function(a) {
                var b = [];
            ...
            "pop": yc.pop,
            "push": yc.push,
            "reduce": yc.reduce || function(a, b) { return k(this, a, b, 0, this.length, 1) },
            "reduceRight": yc.reduceRight || function(a, b) { return k(this, a, b, this.length - 1, -1, -1) },
            "reverse": yc.reverse,
            "selector": null,
            "shift": yc.shift,
            "sort": yc.sort,
            "splice": yc.splice,
            "toArray": function() { return yc.slice.call(this) },
            "to$": function() { return d(this) },
            "toJQuery": function() { return d(this) },
            "unique": function() { return new Yb(this.context, qc(this)) },
            "unshift": yc.unshift
        ...
        }, Yb.registerPlural = $b = function(a, b, e) { Yb.register(a, e), Yb.register(b, function() { var a = e.apply(this, arguments); return a === this ? this : a instanceof Yb ? a.length ? d.isArray(a[0]) ? new Yb(a.context, a[0]) : a[0] : c : a }) };
        var Ac = function(a, b) { if ("number" == typeof a) return [b[a]]; var c = d.map(b, function(a) { return a.nTable }); return d(c).filter(a).map(function() { var a = d.inArray(this, c); return b[a] }).toArray() };
        Zb("tables()", function(a) { return a ? new Yb(Ac(a, this.context)) : this }), Zb("table()", function(a) {
            var b = this.tables(a),
                c = b.context;
            return c.length ? new Yb(c[0]) : b
        }), $b("tables().nodes()", "table().node()", function() { return this.iterator("table", function(a) { return a.nTable }) }), $b("tables().body()", "table().body()", function() { return this.iterator("table", function(a) { return a.nTBody }) }), $b("tables().header()", "table().header()", function() { return this.iterator("table", function(a) { return a.nTHead }) }), $b("tables().footer()", "table().footer()", function() { return this.iterator("table", function(a) { return a.nTFoot }) }), $b("tables().containers()", "table().container()", function() { return this.iterator("table", function(a) { return a.nTableWrapper }) }), Zb("draw()", function(a) { return this.iterator("table", function(b) { N(b, a === !1) }) }), Zb("page()", function(a) { return a === c ? this.page.info().page : this.iterator("table", function(b) { mb(b, a) }) }), Zb("page.info()", function() {
        ...
        }), Zb("page.len()", function(a) { return a === c ? 0 !== this.context.length ? this.context[0]._iDisplayLength : c : this.iterator("table", function(b) { jb(b, a) }) });
        ...
        Zb("ajax.json()", function() { var a = this.context; return a.length > 0 ? a[0].json : void 0 }), Zb("ajax.params()", function() { var a = this.context; return a.length > 0 ? a[0].oAjaxData : void 0 }), Zb("ajax.reload()", function(a, b) { return this.iterator("table", function(c) { Bc(c, b === !1, a) }) }), Zb("ajax.url()", function(a) { var b = this.context; return a === c ? 0 === b.length ? c : (b = b[0], b.ajax ? d.isPlainObject(b.ajax) ? b.ajax.url : b.ajax : b.sAjaxSource) : this.iterator("table", function(b) { d.isPlainObject(b.ajax) ? b.ajax.url = a : b.ajax = a }) }), Zb("ajax.url().load()", function(a, b) { return this.iterator("table", function(c) { Bc(c, b === !1, a) }) });
        var Cc = function(a, b) {
                var e, f, g, h, i, j, k = [];
            ...
            Dc = function(a) { return a || (a = {}), a.filter && !a.search && (a.search = a.filter), { "search": a.search || "none", "order": a.order || "current", "page": a.page || "all" } },
            Ec = function(a) {
            ...
            Fc = function(a, b) {
                ...
                else if ("current" == k || "applied" == k) g = "none" == j ? i.slice() : "applied" == j ? h.slice() : d.map(i, function(a) { return -1 === d.inArray(a, h) ? a : null });
            ...
            Gc = function(a, b, c) { return Cc(b, function(b) { var e = hc(b); if (null !== e && !c) return [e]; var f = Fc(a, c); if (null !== e && -1 !== d.inArray(e, f)) return [e]; if (!b) return f; for (var g = [], h = 0, i = f.length; i > h; h++) g.push(a.aoData[f[h]].nTr); return b.nodeName && -1 !== d.inArray(b, g) ? [b._DT_RowIndex] : d(g).filter(b).map(function() { return this._DT_RowIndex }).toArray() }) };
        ...
        var Oc = /^(.+):(name|visIdx|visible)$/,
            Pc = function(a, b) {
                ...
                return Cc(b, function(b) {
                    ...
                    if (!h) return d(f).filter(b).map(function() { return d.inArray(this, f) }).toArray();
                    switch (h[2]) {
                        case "visIdx":
                        case "visible":
                            var i = parseInt(h[1], 10);
                            if (0 > i) { var j = d.map(c, function(a, b) { return a.bVisible ? b : null }); return [j[j.length + i]] }
                            return [o(a, i)];
                        case "name":
                            return d.map(e, function(a, b) { return a === h[1] ? b : null })
                    }
                })
            },
            Qc = function(a, b, e, f) {
                ...
                if (l.bVisible !== e) {
                    if (e) { var o = d.inArray(!0, mc(k, "bVisible"), b + 1); for (h = 0, i = m.length; i > h; h++) j = m[h].nTr, g = m[h].anCells, j && j.insertBefore(g[b], g[o] || null) } else d(mc(a.aoData, "anCells", b)).detach();
            ...
            return Cc(b, function(a) {
                if (null === a || a === c) {
                    for (g = [], h = 0, i = l.length; i > h; h++)
                        for (f = l[h], j = 0; o > j; j++) g.push({ "row": f, "column": j });
                    return g
                }
                return d.isPlainObject(a) ? [a] : n.filter(a).map(function(a, b) { return f = b.parentNode._DT_RowIndex, { "row": f, "column": d.inArray(b, k[f].anCells) } }).toArray()
            })
        };
        Zb("cells()", function(a, b, e) {
                if (d.isPlainObject(a) && (typeof a.row !== c ? (e = b, b = null) : (e = a, a = null)), d.isPlainObject(b) && (e = b, b = null), null === b || b === c) return this.iterator("table", function(b) { return Rc(b, a, Dc(e)) });
            ...
            }, Wb.tables = Wb.fnTables = function(a) { return jQuery.map(Wb.settings, function(b) { return !a || a && d(b.nTable).is(":visible") ? b.nTable : void 0 }) }, Wb.camelToHungarian = f, Zb("$()", function(a, b) {
            ...
            }), Zb("clear()", function() { return this.iterator("table", function(a) { E(a) }) }), Zb("settings()", function() { return new Yb(this.context, this.context) }), Zb("data()", function() { return this.iterator("table", function(a) { return mc(a.aoData, "_aData") }).flatten() }), Zb("destroy()", function(b) {
                ...
                "sServerMethod": "GET",
                "renderer": null
            }, e(Wb.defaults), Wb.defaults.column = { "aDataSort": null, "iDataSort": -1, "asSorting": ["asc", "desc"], "bSearchable": !0, "bSortable": !0, "bVisible": !0, "fnCreatedCell": null, "mData": null, "mRender": null, "sCellType": "td", "sClass": "", "sContentPadding": "", "sDefaultContent": null, "sName": "", "sSortDataType": "std", "sTitle": null, "sType": null, "sWidth": null }, e(Wb.defaults.column), Wb.models.oSettings = {
        ...
        var Sc = Wb.ext.pager;
        d.extend(Sc, { "simple": function() { return ["previous", "next"] }, "full": function() { return ["first", "previous", "next", "last"] }, "simple_numbers": function(a, b) { return ["previous", Tb(a, b), "next"] }, "full_numbers": function(a, b) { return ["first", "previous", Tb(a, b), "next", "last"] }, "_numbers": Tb, "numbers_length": 7 }), d.extend(!0, Wb.ext.renderer, {
            "pageButton": {
                "_": function(a, c, e, f, g, h) {
                    var i, j, k = a.oClasses,
                        ...
                        m = 0,
                        n = function(b, c) {
                            var f, o, p, q, r = function(b) { mb(a, b.data.action, !0) };
        ...
        var Tc = function(a, b, c, d) { return a && "-" !== a ? (b && (a = ic(a, b)), a.replace && (c && (a = a.replace(c, "")), d && (a = a.replace(d, ""))), 1 * a) : -1 / 0 };
