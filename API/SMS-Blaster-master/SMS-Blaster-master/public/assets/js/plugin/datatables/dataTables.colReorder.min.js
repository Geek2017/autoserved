/*! SmartAdmin - v1.5 - 2014-09-27 */ ! function(a, b, c) {
    function d(a) { for (var b = [], c = 0, d = a.length; d > c; c++) b[a[c]] = c; return b }
    ...
    $.fn.dataTableExt.oApi.fnColReorder = function(a, b, c) {
        ...
        if (b != c) {
            ...
            for (m && $.each(a.aLastSort, function(b, c) { a.aLastSort[b].src = p[c.src] }), g = 0, h = n; h > g; g++) l = a.aoColumns[g], "number" == typeof l.mData && (l.mData = p[l.mData], a.oApi._fnColumnOptions(a, g, {}));
    ...
    var g = function(a) {
        "use strict";
        var f = function(b, c) { var d; return a.fn.dataTable.Api ? d = new a.fn.dataTable.Api(b).settings()[0] : b.fnSettings ? d = b.fnSettings() : "string" == typeof b ? a.fn.dataTable.fnIsDataTable(a(b)[0]) && (d = a(b).eq(0).dataTable().fnSettings()) : b.nodeName && "table" === b.nodeName.toLowerCase() ? a.fn.dataTable.fnIsDataTable(b.nodeName) && (d = a(b.nodeName).dataTable().fnSettings()) : b instanceof jQuery ? a.fn.dataTable.fnIsDataTable(b[0]) && (d = b.eq(0).dataTable().fnSettings()) : d = b, a.fn.dataTable.camelToHungarian && a.fn.dataTable.camelToHungarian(f.defaults, c || {}), this.s = { "dt": null, "init": a.extend(!0, {}, f.defaults, c), "fixed": 0, "fixedRight": 0, "dropCallback": null, "mouse": { "startX": -1, "startY": -1, "offsetX": -1, "offsetY": -1, "target": -1, "targetIndex": -1, "fromIndex": -1 }, "aoTargets": [] }, this.dom = { "drag": null, "pointer": null }, this.s.dt = d.oInstance.fnSettings(), this.s.dt._colReorder = this, this._fnConstruct(), d.oApi._fnCallbackReg(d, "aoDestroyCallback", a.proxy(this._fnDestroy, this), "ColReorder"), this };
        return f.prototype = {
            "fnReset": function() { for (var a = [], b = 0, c = this.s.dt.aoColumns.length; c > b; b++) a.push(this.s.dt.aoColumns[b]._ColReorder_iOrigCol); return this._fnOrderColumns(a), this },
            "fnGetCurrentOrder": function() { return this.fnOrder() },
            "fnOrder": function(a) { if (a === c) { for (var b = [], e = 0, f = this.s.dt.aoColumns.length; f > e; e++) b.push(this.s.dt.aoColumns[e]._ColReorder_iOrigCol); return b } return this._fnOrderColumns(d(a)), this },
            "_fnConstruct": function() {
                ...
                this.s.dt.oApi._fnCallbackReg(this.s.dt, "aoStateSaveParams", function(a, c) { b._fnStateSave.call(b, c) }, "ColReorder_State");
                var e = null;
            ...
            "_fnMouseDown": function(d, e) {
                ...
                i !== c && (this.s.mouse.startX = d.pageX, this.s.mouse.startY = d.pageY, this.s.mouse.offsetX = d.pageX - h.left, this.s.mouse.offsetY = d.pageY - h.top, this.s.mouse.target = this.s.dt.aoColumns[i].nTh, this.s.mouse.targetIndex = i, this.s.mouse.fromIndex = i, this._fnRegions(), a(b).on("mousemove.ColReorder", function(a) { f._fnMouseMove.call(f, a) }).on("mouseup.ColReorder", function(a) { f._fnMouseUp.call(f, a) }))
            },
            "_fnMouseMove": function(a) {
                ...
                for (var b = !1, c = this.s.mouse.toIndex, d = 1, e = this.s.aoTargets.length; e > d; d++)
                    if (a.pageX < this.s.aoTargets[d - 1].x + (this.s.aoTargets[d].x - this.s.aoTargets[d - 1].x) / 2) { this.dom.pointer.css("left", this.s.aoTargets[d - 1].x), this.s.mouse.toIndex = this.s.aoTargets[d - 1].to, b = !0; break }
                b || (this.dom.pointer.css("left", this.s.aoTargets[this.s.aoTargets.length - 1].x), this.s.mouse.toIndex = this.s.aoTargets[this.s.aoTargets.length - 1].to), this.s.init.bRealtime && c !== this.s.mouse.toIndex && (this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex, this.s.mouse.toIndex), this.s.mouse.fromIndex = this.s.mouse.toIndex, this._fnRegions())
            },
            "_fnMouseUp": function() { a(b).off("mousemove.ColReorder mouseup.ColReorder"), null !== this.dom.drag && (this.dom.drag.remove(), this.dom.pointer.remove(), this.dom.drag = null, this.dom.pointer = null, this.s.dt.oInstance.fnColReorder(this.s.mouse.fromIndex, this.s.mouse.toIndex), this._fnSetColumnIndexes(), ("" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY) && this.s.dt.oInstance.fnAdjustColumnSizing(), null !== this.s.dropCallback && this.s.dropCallback.call(this), this.s.dt.oInstance.oApi._fnSaveState(this.s.dt)) },
            "_fnRegions": function() {
            ...
            "_fnDestroy": function() {
                ...
                for (b = 0, c = this.s.dt.aoDrawCallback.length; c > b; b++)
                    if ("ColReorder_Pre" === this.s.dt.aoDrawCallback[b].sName) { this.s.dt.aoDrawCallback.splice(b, 1); break }
                a(this.s.dt.nTHead).find("*").off(".ColReorder"), a.each(this.s.dt.aoColumns, function(b, c) { a(c.nTh).removeAttr("data-column-index") }), this.s.dt._colReorder = null, this.s = null
            },
            "_fnSetColumnIndexes": function() { a.each(this.s.dt.aoColumns, function(b, c) { a(c.nTh).attr("data-column-index", b) }) }
            ...
            "cFeature": "R",
            "sFeature": "ColReorder"
        }) : alert("Warning: ColReorder requires DataTables 1.9.3 or greater - www.datatables.net/download"), a.fn.dataTable.Api && (a.fn.dataTable.Api.register("colReorder.reset()", function() { return this.iterator("table", function(a) { a._colReorder.fnReset() }) }), a.fn.dataTable.Api.register("colReorder.order()", function(a) { return a ? this.iterator("table", function(b) { b._colReorder.fnOrder(a) }) : this.context.length ? this.context[0]._colReorder.fnOrder() : null })), f
    };
