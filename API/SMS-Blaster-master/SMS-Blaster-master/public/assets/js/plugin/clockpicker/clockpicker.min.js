/*! SmartAdmin - v1.5 - 2014-09-27 */ ! function() {
    function a(a) { return document.createElementNS(i, a) }

    function b(a) { return (10 > a ? "0" : "") + a }

    function c(a) { var b = ++q + ""; return a ? a + b : b }
    ...
    function d(d, g) {
        function i(a, b) {
            ...
            if (!b || !(s - u > p || p > s + u)) {
                a.preventDefault();
                var t = setTimeout(function() { e.addClass("clockpicker-moving") }, 200);
                j && l.append(B.canvas), B.setHand(k, m, !b, !0), h.off(n).on(n, function(a) {
                    ...
                    (b || q) && d === k && j === m && B.setHand(d, j), "hours" === B.currentView ? B.toggleView("minutes", w / 2) : g.autoclose && (B.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() { B.done() }, w / 2)), l.prepend(I), clearTimeout(t), e.removeClass("clockpicker-moving"), h.off(n)
                })
            }
        }
        var k = f(x),
        ...
        if (l.on(m, function(a) { 0 === f(a.target).closest(".clockpicker-tick").length && i(a, !0) }), j) {
    ...
    var e, f = window.jQuery,
        ...
        j = "SVGAngle" in window && function() { var a, b = document.createElement("div"); return b.innerHTML = "<svg/>", a = (b.firstChild && b.firstChild.namespaceURI) == i, b.innerHTML = "", a }(),
        k = function() { var a = document.createElement("div").style; return "transition" in a || "WebkitTransition" in a || "MozTransition" in a || "msTransition" in a || "OTransition" in a }(),
    ...
    d.DEFAULTS = { "default": "", "fromnow": 0, "placement": "bottom", "align": "left", "donetext": "\u5b8c\u6210", "autoclose": !1, "vibrate": !0 }, d.prototype.toggle = function() { this[this.isShown ? "hide" : "show"]() }, d.prototype.locate = function() {
        var a = this.element,
            b = this.popover,
            c = a.offset(),
            d = a.outerWidth(),
        ...
        if (!this.isShown) {
            var a = this;
            this.isAppended || (e = f(document.body).append(this.popover), g.on("resize.clockpicker" + this.id, function() { a.isShown && a.locate() }), this.isAppended = !0);
            ...
            }), h.on("keyup.clockpicker." + this.id, function(b) { 27 === b.keyCode && a.hide() })
        }
    }, d.prototype.hide = function() { this.isShown = !1, h.off("click.clockpicker." + this.id + " focusin.clockpicker." + this.id), h.off("keyup.clockpicker." + this.id), this.popover.hide() }, d.prototype.toggleView = function(a, b) {
        var c = "hours" === a,
            d = c ? this.hoursView : this.minutesView,
            e = c ? this.minutesView : this.hoursView;
        this.currentView = a, this.spanHours.toggleClass("text-primary", c), this.spanMinutes.toggleClass("text-primary", !c), e.addClass("clockpicker-dial-out"), d.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(b), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function() { e.css("visibility", "hidden") }, w)
        ...
        var b = this.currentView,
            ...
            i = -Math.cos(f) * g,
            k = this;
        j && a ? (k.canvas.addClass("clockpicker-canvas-out"), setTimeout(function() { k.canvas.removeClass("clockpicker-canvas-out"), k.setHand(h, i) }, a)) : this.setHand(h, i)
    ...
    }, d.prototype.remove = function() { this.element.removeData("clockpicker"), this.input.off("focus.clockpicker click.clockpicker"), this.addon.off("click.clockpicker"), this.isShown && this.hide(), this.isAppended && (g.off("resize.clockpicker" + this.id), this.popover.remove()) }, f.fn.clockpicker = function(a) {
