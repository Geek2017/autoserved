/*! SmartAdmin - v1.5 - 2014-09-27 */ ! function(a) { var b = function(a) { this.value = { "h": 1, "s": 1, "b": 1, "a": 1 }, this.setColor(a) };
    b.prototype = { "constructor": b, "setColor": function(b) { b = b.toLowerCase(); var c = this;
            a.each(d.stringParsers, function(a, e) { var f = e.re.exec(b),
                    g = f && e.parse(f),
                    h = e.space || "rgba"; return g ? (c.value = "hsla" === h ? d.RGBtoHSB.apply(null, d.HSLtoRGB.apply(null, g)) : d.RGBtoHSB.apply(null, g), !1) : void 0 }) }, "setHue": function(a) { this.value.h = 1 - a }, "setSaturation": function(a) { this.value.s = a }, "setLightness": function(a) { this.value.b = 1 - a }, "setAlpha": function(a) { this.value.a = parseInt(100 * (1 - a), 10) / 100 }, "toRGB": function(a, b, c, d) { a || (a = this.value.h, b = this.value.s, c = this.value.b), a *= 360; var e, f, g, h, i; return a = a % 360 / 60, i = c * b, h = i * (1 - Math.abs(a % 2 - 1)), e = f = g = c - i, a = ~~a, e += [i, h, 0, 0, h, i][a], f += [h, i, i, h, 0, 0][a], g += [0, 0, h, i, i, h][a], { "r": Math.round(255 * e), "g": Math.round(255 * f), "b": Math.round(255 * g), "a": d || this.value.a } }, "toHex": function(a, b, c, d) { var e = this.toRGB(a, b, c, d); return "#" + (1 << 24 | parseInt(e.r) << 16 | parseInt(e.g) << 8 | parseInt(e.b)).toString(16).substr(1) }, "toHSL": function(a, b, c, d) { a || (a = this.value.h, b = this.value.s, c = this.value.b); var e = a,
                f = (2 - b) * c,
                g = b * c; return g /= f > 0 && 1 >= f ? f : 2 - f, f /= 2, g > 1 && (g = 1), { "h": e, "s": g, "l": f, "a": d || this.value.a } } }; var c = function(b, c) { this.element = a(b); var e = c.format || this.element.data("color-format") || "hex";
