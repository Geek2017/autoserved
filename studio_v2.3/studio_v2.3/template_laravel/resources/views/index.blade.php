						...
						<div class="card-body position-relative">
							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<hr class="hr-transparent bg-white mt-3 mb-3" />
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="d-flex">
										...
										<div class="w-50px h-50px bg-primary-transparent-2 rounded-circle d-flex align-items-center justify-content-center">
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-6 text-center">
											<div class="w-50px h-50px bg-primary-transparent-2 rounded-circle d-flex align-items-center justify-content-center mb-2 ms-auto me-auto">
								...
								<table class="table table-borderless mb-0">
									...
									<tbody>
										<tr>
											...
											<td class="text-center"><span class="badge bg-success-transparent-2 text-success" style="min-width: 60px;">Success</span></td>
										...
										<tr>
											...
											<td class="text-center"><span class="badge bg-warning-transparent-2 text-warning" style="min-width: 60px;">Pending</span></td>
										...
										<tr>
											...
											<td class="text-center"><span class="badge text-dark-transparent-5 bg-dark-transparent-1" style="min-width: 60px;">Cancelled</span></td>
										...
										<tr>
											...
											<td class="text-center"><span class="badge bg-success-transparent-2 text-success" style="min-width: 60px;">Cancelled</span></td>
