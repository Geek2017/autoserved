								...
								<div id="chartJsPolarAreaChart" class="mb-5">
									<div class="card">
										<div class="card-body">
											...
											<div class="h-300px w-300px mx-auto"><canvas id="polarAreaChart"></canvas></div>
										</div>
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- required js --&gt;
&lt;script src="/assets/plugins/chart.js/dist/Chart.min.js"/&gt;&lt;/script&gt;
...
&lt;/script&gt;</code></pre>
								...
								<div id="chartJsPieChart" class="mb-5">
									<div class="card">
										<div class="card-body">
											<h6>PIE CHART</h6>
											<div class="h-300px w-300px mx-auto"><canvas id="pieChart"></canvas></div>
										</div>
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- required js --&gt;
&lt;script src="/assets/plugins/chart.js/dist/Chart.min.js"/&gt;&lt;/script&gt;
								...
								<div id="chartJsDoughnutChart" class="mb-5">
									<div class="card">
										<div class="card-body">
											...
											<div class="h-300px w-300px mx-auto"><canvas id="doughnutChart"></canvas></div>
										</div>
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- required js --&gt;
&lt;script src="/assets/plugins/chart.js/dist/Chart.min.js"/&gt;&lt;/script&gt;
