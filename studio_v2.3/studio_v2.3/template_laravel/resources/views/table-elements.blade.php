								...
								<div id="basicTable" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row mb-n3">
												<div class="col-xl-6">
													<div class="fs-12px text-muted mb-3"><b>DEFAULT TABLE</b></div>
													<table class="table">
														<thead>
															<tr>
																<th scope="col">#</th>
												...
												<div class="col-xl-6">
													<div class="fs-12px text-muted mb-3"><b>DARK TABLE</b></div>
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- default table --&gt;
&lt;table class="table"&gt;
  &lt;thead&gt;
    &lt;tr&gt;
      &lt;th scope="col"&gt;#&lt;/th&gt;
								...
								<div id="tableHeadOptions" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row mb-n3">
												<div class="col-xl-6">
													<div class="fs-12px text-muted mb-3"><b>DARK HEADER</b></div>
													<table class="table">
												...
												<div class="col-xl-6">
													<div class="fs-12px text-muted mb-3"><b>LIGHT HEADER</b></div>
													<table class="table">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- thead-light --&gt;
&lt;table class="table"&gt;
...
&lt;/table&gt;</code></pre>
								...
								<div id="stripedRows" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- table-striped --&gt;
...
&lt;/table&gt;</code></pre>
								...
								<div id="borderedTable" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- table-bordered --&gt;
...
&lt;/table&gt;</code></pre>
								...
								<div id="borderlessTable" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- table-borderless --&gt;
...
&lt;/table&gt;</code></pre>
								...
								<div id="hoverableRows" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- table-hover --&gt;
...
&lt;/table&gt;</code></pre>
								...
								<div id="smallTable" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- table-sm --&gt;
...
&lt;/table&gt;</code></pre>
								...
								<div id="contextualClasses" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- On rows --&gt;
...
&lt;/tr&gt;</code></pre>
								...
								<div id="captions" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- caption --&gt;
&lt;table class="table"&gt;
  &lt;caption&gt;List of users&lt;/caption&gt;
  &lt;thead&gt;...&lt;/thead&gt;
  &lt;tbody&gt;...&lt;/tbody&gt;
&lt;/table&gt;</code></pre>
								...
								<div id="responsiveTables" class="mb-5">
									...
									<div class="card">
										...
										<div class="hljs-container rounded-bottom"><pre><code>&lt;!-- table-responsive --&gt;
